...
pub struct WebhookFormProps {
    pub initial_url: String,
    pub show_errors: bool,
    pub on_change: Callback<Option<NotificationChannelConfigInput>>,
}

#[function_component(WebhookForm)]
pub fn webhook_form(props: &WebhookFormProps) -> Html {
...
fn build_config(url: &str) -> Option<NotificationChannelConfigInput> {
    super::is_valid_url(url).then(|| NotificationChannelConfigInput::Webhook {
